...
<script type="text/javascript">
	$(function(){
		...
		$('.bt_save').on('click',function(){
			$.post("/admin/productType/update",$("form").serialize(),function (e) {
				console.log(e);
				if(e == "0"){
			...
			<div class="hp-form-item">
				...
				<div class="hp-input-block">
					<label class="hp-input" style="height: 36px; cursor:pointer;" id="icon_input" p>
						<i id="iconfont" class="iconfont ${productType.productTypeIcon }" style="font-size: 25px !important; position: absolute; top: 5px; left: 30px;"></i>
					</label>
				</div>	
			</div>
